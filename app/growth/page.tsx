...
const CATEGORIES = [
  { name: "All Struggles", icon: "🌱", count: 0 },
  { name: "Hall of Fame", icon: "🏆", count: 0 },
  { name: "Internships", icon: "💼", count: 0 },
  { name: "Exams", icon: "📝", count: 0 },
  { name: "Skills", icon: "🧠", count: 0 },
  { name: "Career", icon: "📈", count: 0 },
  { name: "Mental Health", icon: "❤️‍🩹", count: 0 },
...
export default function CampusPage() {
  ...
  const handleSubmit = async () => {
    if (!title.trim()) {
      toast.error("Please provide a struggle title! 😅");
      return;
    }
    if (!description.trim()) {
      toast.error("Please explain your struggle in the description! 😅");
      return;
    }
    ...
    <div className="h-screen overflow-hidden bg-[#060606] text-gray-200 font-sans flex flex-col relative w-full">
      ...
      <header className="h-[72px] bg-[#0a0a0a] border-b border-zinc-900 flex items-center justify-between px-6 sticky top-0 z-10 shrink-0">
        <div className="flex flex-col">
          <h1 className="text-[22px] font-bold text-white tracking-tight leading-tight">Growth Mode</h1>
          <span className="text-xs text-gray-400">Share struggles & grow together</span>
        </div>
                  ...
                  >
                    ...
                    {p.status === "solved" && p.solution && (
                      <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-4 mb-5">
                        <div className="text-[11px] font-bold text-green-400 mb-1.5 uppercase tracking-wider">Solution / Growth:</div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#111111] border border-zinc-800 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-6 space-y-5">
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-1.5">Struggle Title</label>
                <input
                  type="text"
                  value={title}
                  onChange={(e) => setTitle(e.target.value)}
                  placeholder="e.g. Not getting any internship calls"
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Explain your struggle in detail... What's stopping your growth?"
      ...
      {isSolutionModalOpen && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#111111] border border-zinc-800 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-6 space-y-5">
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-1.5">How did you resolve this struggle?</label>
                <textarea
                  value={solutionText}
